...
unsafe extern "C" {
    ...
    ///
    /// - `rk`: Instance to use.
    /// - `cntp`: Will be updated to the number of brokers returned.
    ///
...
unsafe extern "C" {
    /// Gets type for the \p grpdesc group.
    ///
    /// - `grpdesc`: The group description.
    ///
    /// Returns A group type.
...
unsafe extern "C" {
    /// Gets target assignment of \p member.
    ///
    /// - `member`: The group member.
    ///
    /// Returns The target assignment for `consumer` group types.
